...
export function easeQuadOut(elapsedByDuration, elapsed, min, max, duration) {
  return min + max * Math.sqrt(1 - Math.pow((elapsedByDuration - 1), 2));
}
...
export class GenericScrollBox extends React.Component {
  ...
  static defaultProps = {
    ...
    swapWheelAxes: false,
    wheelScrollDurationX: 300,
    wheelScrollDurationY: 300,
  ...
  constructor(props) {
          ...
          <div style={style}
            ...
            <div className="scroll-box__track scroll-box__track--y"
              ...
              <div className="scroll-box__handle scroll-box__handle--y"
                   ...
                   ref="handleY">
                <div className="scroll-box__handle--y-view">
                  {handleChildrenY}
                </div>
              </div>
              {trackChildrenY}
    ...
    const propagateChanges = () => {
      ...
      // }
      if (clientScrollingY && elapsedY >= _durationY) {
        _targetY = nextScrollY = scrollTop;
      }
