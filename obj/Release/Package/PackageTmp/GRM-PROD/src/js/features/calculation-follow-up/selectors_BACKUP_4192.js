...
import WarningsErrors from '../../components/business/warnings-errors/warnings-errors';
  ...
  (data, editMode, menuButtons) => {
    const columns = [
      ...
      },
      {
        ...
        sortable: false,
<<<<<<< HEAD
        show: false, // TODO: remove when back-end for GRFWEB-6341 is ready and check if contracts are okay
        Cell: (row) => {
...
=======
        Cell: (row) => {
          const { original: { errorsCount, warningsCount } } = row;

          return <WarningsErrors warnings={ warningsCount } errors={ errorsCount } />;
>>>>>>> fda7b5752644d9dc7f9f201d4aecfe2d940deab6
        },
      },
      {
        id: 'menu',
